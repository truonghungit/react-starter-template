export default function Footer() {
  return (
    <div className='text-gray-700 bg-white body-font'>
      <div className='container mx-auto xl:max-w-7xl flex flex-col items-center px-4 py-8  sm:flex-row'>
        <a href='#_' className='text-xl font-black leading-none text-gray-900 select-none logo'>
          React Starter<span className='text-indigo-600'>.</span>
        </a>
        ...
        <span className='inline-flex justify-center mt-4 space-x-5 sm:ml-auto sm:mt-0 sm:justify-start'>
          ...
          <a href='Dribbble' className='text-gray-400 hover:text-gray-500'>
