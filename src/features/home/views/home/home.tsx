              ...
              <div className='rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50'>
                ...
                <div className='py-6 px-5'>
                  <div className='grid grid-cols-2 gap-4'>
                    ...
                    <a href='#Partners' className='text-base font-medium text-gray-900 hover:text-gray-700'>
                      Partners
                    </a>
                    <a href='#Company' className='text-base font-medium text-gray-900 hover:text-gray-700'>
                      Company
                    </a>
                  </div>
                  <div className='mt-6'>
